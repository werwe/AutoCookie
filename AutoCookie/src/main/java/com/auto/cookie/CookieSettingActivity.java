...
public class CookieSettingActivity extends ActionBarActivity implements ActionBar.OnNavigationListener {
...
//        carousel.setUsesDualTabs(true);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.cookie_setting, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_cookie_main, container, false);
